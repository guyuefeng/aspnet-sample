<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GetOrder.aspx.cs" Inherits="GetJson_JsonData" %>
...
<body>
    ...
    <div>
        ...
        <table cellpadding=5 cellspacing=1 width=620 id="productTable" align=center>
            <tr>
                <th style="width:100px"><a style="cursor:pointer;" onclick="Sort('orderid','productid');return false;">订单编号</a><span id="productid" class="ordertip"></span></th>
                <th style="width:200px"><a style="cursor:pointer;" onclick="Sort('customerid','ProductName');return false;">客户编号</a><span id="ProductName" class="ordertip"></span></th>
                <th style="width:200px"><a style="cursor:pointer;" onclick="Sort('shipname','UnitPrice');return false;">商店名称</a><span id="UnitPrice" class="ordertip"></span></th>
                <th style="width:120px"><a style="cursor:pointer;" onclick="Sort('shipcity','Discontinued');return false;">城市</a><span id="Discontinued" class="ordertip"></span></th>
            </tr>
        </table>
